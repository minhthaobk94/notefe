...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.title = 'NHK Easy Reading App';
    }
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_4__service_post_service__["a" /* PostService */]],
...
module.exports = "<div class=\"container\">\n  <div class=\"row\">\n    <div class=\"col-xl-4\">\n      <ul class=\"list-group\">\n        <li [class.active]=\"post === selectedPost\" class=\"list-group-item list-group-item-action post-link\" *ngFor=\"let post of posts\" (click)=\"onSelect(post)\">\n          {{getPostTitle(post)}}\n        </li>\n      </ul>\n    </div>\n    <div class=\"col-xl-8\">\n      <div class=\"selected-post\" *ngIf=\"selectedPost !== undefined\">\n        <ul class=\"list-group\">\n          <li *ngFor=\"let segment of selectedPost.segments\" class=\"list-group-item list-group-item-action\">\n            <div class=\"form-group\">\n              <label for=\"exampleTextarea\">{{segment.text}}</label>\n              <textarea class=\"form-control\" id=\"exampleTextarea\" placeholder=\"translation here\" rows=\"2\"></textarea>\n            </div>\n          </li>\n          <li class=\"list-group-item list-group-item-action\">\n            <button type=\"submit\" class=\"btn btn-outline-primary float-left\">Save</button>\n          </li>\n        </ul>\n      </div>\n    </div>\n  </div>\n</div>\n"
...
var PostsComponent = /** @class */ (function () {
    ...
    PostsComponent.prototype.getPostTitle = function (post) {
        var segment = post.segments.find(function (segment) {
            return segment.segmentType.text === 'title';
        });
        return segment.text;
    };
    ...
    PostsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__service_post_service__["a" /* PostService */]])
    ], PostsComponent);
